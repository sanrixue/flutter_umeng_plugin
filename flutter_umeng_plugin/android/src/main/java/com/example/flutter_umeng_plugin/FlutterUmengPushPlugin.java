...
public class FlutterUmengPushPlugin implements MethodCallHandler {

    private static String TAG = "umeng_push";
    public static FlutterUmengPushPlugin instance;
    public final MethodChannel channel;
    private static Registrar registrar;

    public static void registerWith(Registrar registrar) {
        instance = new FlutterUmengPushPlugin(registrar);
    }

    private FlutterUmengPushPlugin(Registrar registrar) {
        FlutterUmengPushPlugin.registrar = registrar;
        MethodChannel channel = new MethodChannel(registrar.messenger(), "umeng_push");
