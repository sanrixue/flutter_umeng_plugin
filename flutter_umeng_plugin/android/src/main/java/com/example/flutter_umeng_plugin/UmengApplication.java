    ...
    public void onCreate() {
        ...
        UmengNotificationClickHandler notificationClickHandler = new UmengNotificationClickHandler() {
            public void launchApp(Context context, UMessage uMessage) {
                ...
                FlutterUmengPushPlugin.instance.channel.invokeMethod("onMessage", umengPushMsg, FLUTTER_METHOD_CALLBACK);
        ...
        pushAgent.register(new
                                   ...
                                   IUmengRegisterCallback() {
                                       ...
                                       public void onSuccess(String deviceToken) {
                                           ...
                                           if (FlutterUmengPushPlugin.instance != null) {
                                               //Flutter插件已经初始化完成，可以直接调用
                                               FlutterUmengPushPlugin.instance.channel.invokeMethod("onToken", deviceToken, FLUTTER_METHOD_CALLBACK);
